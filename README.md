...
the source distribution for XZ Utils 5.8.3.
...
package is written into the project root with the name `xz-5.8.3.pkg`.  
...
if notarization succeeds.  Use the command:
        ...
        $ xcrun stapler validate --verbose xz-5.8.3.pkg
